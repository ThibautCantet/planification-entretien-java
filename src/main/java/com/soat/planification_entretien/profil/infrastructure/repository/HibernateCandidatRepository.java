...
public class HibernateCandidatRepository implements CandidatRepository {
    ...
    public Candidat save(Candidat candidat) {
        var toSave = new com.soat.planification_entretien.profil.infrastructure.repository.Candidat(candidat.getLanguage(), candidat.getEmail(), candidat.getExperienceInYears());
