...
public class PlanifierEntretienCommandHandler implements CommandHandler<PlanifierEntretienCommandHandler.PlanifierEntretienCommand, CommandResponse<Event>> {
    ...
    public CommandResponse<Event> handle(PlanifierEntretienCommand command) {
        ...
        if (entretien.planifier(command.dateEtHeureDisponibiliteDuCandidat(), command.dateEtHeureDisponibiliteDuRecruteur()) instanceof EntretienPlanifié entretienPlanifié) {
            ...
            return new CommandResponse<>(entretienPlanifié);
        }
        return new CommandResponse<>(new EntretienNonPlanifié());
    }
