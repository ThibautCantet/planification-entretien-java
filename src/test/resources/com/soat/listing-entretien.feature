...
Fonctionnalité: Lister un entretien de recrutement chez Soat
  ...
  Scénario: Lister les entretiens déjà planifiés
    ...
    Alors on récupères les entretiens suivants
      ...
      | 1  | recruteur@soat.fr | candidat@mail.com | Java     | 16/04/2019 15:00 | PLANIFIE |

  Scénario: Compter les entretiens annulés
    Etant donné les recruteurs existants
      | id | email             | language | xp |
      | 1  | recruteur@soat.fr | Java     | 10 |
    Et les candidats existants
    ...
    Et les entretiens existants
      | id | recruteur | candidat | horaire          | status   |
      | 1  | 1         | 1        | 16/04/2019 15:00 | PLANIFIE |
    Et que on annule l'entretien 1
    Quand on compte tous les entretiens annulés
    Alors on récupère le nombre d'entretiens annulés 1
