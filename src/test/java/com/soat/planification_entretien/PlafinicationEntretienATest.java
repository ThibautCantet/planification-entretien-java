...
public class PlafinicationEntretienATest extends ATest {
    ...
    @Autowired
    private EntretienPort entretienRepository;
    @Autowired
    private CandidatPort candidatRepository;
    @Autowired
    ...
    public void unCandidatAvecAnsDExpériencesQuiEstDisponibleÀ(String language, String email, String experienceInYears, String date, String time) {
        ...
        int id = candidatRepository.save(candidat);
        candidat = new Candidat(id, language, email, Integer.parseInt(experienceInYears));
    ...
    public void unRecruteurQuiAAnsDXPQuiEstDispo(String language, String email, String experienceInYears, String date, String time) {
        ...
        int id = recruteurRepository.save(recruteur);
        recruteur = new Recruteur(id, language, email, Integer.parseInt(experienceInYears));
