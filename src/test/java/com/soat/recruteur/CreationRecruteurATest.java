...
import com.soat.planification_entretien.profil.infrastructure.controller.RecruteurController;
...
import com.soat.planification_entretien.profil.infrastructure.controller.RecruteurDto;
...
public class CreationRecruteurATest extends ATest {
    ...
    public void leRecruteurEstCorrectementEnregistréAvecSesInformationsEtAnsDExpériences(String language, String email, String experienceEnAnnees) {
        ...
        assertThat(recruteur).usingRecursiveComparison()
                .ignoringFields("id")
                .isEqualTo(new Recruteur(recruteur.getId(), language, email, Integer.parseInt(experienceEnAnnees), recruteur.isDisponible()));
    }
